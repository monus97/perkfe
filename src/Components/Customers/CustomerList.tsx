      ...
      <div className="containr mt-3 p-3">
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          <div>
            ...
            <Subtitle>List of customers and their details</Subtitle>
          </div>
        ...
        <table className="table mt-4 ">
          <thead>
            <tr className="table-light">
              <Colortext style={{ color: "blue" }}>CUSTOMER NAME</Colortext>
              <Colortext>ORGANIZATION</Colortext>
              <Colortext>CONTACT</Colortext>
              <Colortext>EMAIL</Colortext>
              <Colortext>STATUS</Colortext>
              <Colortext>CREATED DATE</Colortext>
              <Colortext>TOTAL ORDERS</Colortext>
              <Colortext>TOTAL SALES</Colortext>
          ...
          <tbody className="tableBody">
            {customerList.map((customer, index) => (
              <tr key={index}>
                ...
                >
                  <span className="customerId">{customer?.name}</span>
                </Linktext>
                <Colortext>{customer?.organizationDetails?.name}</Colortext>
                <Linktext>{customer?.mobile}</Linktext>
                <Linktext>{customer?.email}</Linktext>
                <Linktext></Linktext>
                <Colortext>{formatDate(customer?.createdAt)}</Colortext>
                <Colortext>{customer?.totalAmount}</Colortext>
                <Colortext>{customer?.ordersCount}</Colortext>
                <Colortext>
                  <span
                    className="deletebtn"
